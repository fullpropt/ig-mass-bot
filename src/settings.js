...
const settings = {
  ...
  captchaKey: process.env.CAPTCHA_API_KEY || process.env.CAPTCHA_2CAPTCHA_KEY || '',
  captchaAnti: process.env.CAPTCHA_ANTICAPTCHA_KEY || '',
  captchaCap: process.env.CAPTCHA_CAPSOLVER_KEY || '',
  tempMailAlt1Url: process.env.TEMPMAIL_ALT1_URL || 'https://www.1secmail.com/api/v1/',
  tempMailAlt2Url: process.env.TEMPMAIL_ALT2_URL || 'https://api.guerrillamail.com/ajax.php',
