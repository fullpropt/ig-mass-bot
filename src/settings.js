...
const settings = {
  ...
  captcha2: process.env.CAPTCHA_2CAPTCHA_KEY || '',
  captchaAnti: process.env.CAPTCHA_ANTICAPTCHA_KEY || '',
  captchaCap: process.env.CAPTCHA_CAPSOLVER_KEY || '',
  tempMailUrl: process.env.TEMPMAIL_API_URL || '',
  tempMailToken: process.env.TEMPMAIL_API_TOKEN || '',
  tempMailAlt1Url: process.env.TEMPMAIL_ALT1_URL || '',
  tempMailAlt1Token: process.env.TEMPMAIL_ALT1_TOKEN || '',
  tempMailAlt2Url: process.env.TEMPMAIL_ALT2_URL || '',
  tempMailAlt2Token: process.env.TEMPMAIL_ALT2_TOKEN || '',
